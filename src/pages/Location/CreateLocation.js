    ...
    return (
      <Result
        ...
        extra={[
          ...
          <Button
            key="buy"
            onClick={() => alert("redirect page to block menu")}
          >
            Cancel
          </Button>,
        ]}
    ...
    axios({
      ...
      .then((res) => {
        ...
        axios({
          ...
          .then((res) => {
            console.log(
              "see this is response including newly added locaiton",
              res
            );
          ...
          .catch((err) => {
            setLoading(false);
            console.log(
              "see this is an error from locaiton page --------> ",
              err
            );
          });
        // setStatusPopup(true);
      ...
      .catch((err) => {
        ...
        setStatusPopup(true);
        console.log(
          "see this is an error from create location --------> ",
          err
        );
      });
  };
