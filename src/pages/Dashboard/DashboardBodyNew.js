              ...
              <Col xs={24} md={12} sm={24} lg={12} xl={14} className="mobile-24">
                <div className="h-full col-content p-20">
                  <div className="ant-muse">
                    <Text>Celaning status</Text>
                    <Title level={5}>Task logger dashboard for location status</Title>
                    <Paragraph className="lastweek mb-36">
                      You can see current status of cleaning work for corresponding location here
                    </Paragraph>
                  </div>
          ...
          <Card bordered={false} className="criclebox card-info-2 h-full">
            <div className="gradent h-full col-content">
              <div className="card-content">
                <Title level={5}>Link for sending Notificaiton/post</Title>
                <p>A form will be added for viewing and sending notificaiton and post here.</p>
              </div>
              <div className="card-footer">
                <a className="icon-move-right" href="#pablo">
                  Expand
...
export default DashboardBodyNew;
